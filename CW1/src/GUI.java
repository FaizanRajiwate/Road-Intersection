...
public class GUI extends JFrame {
	...
	public JScrollPane addVehicleTable(LinkedList<Phases> phaseList) {
		String[] columnNames = { "plate number", "type", "crossing time (s)", "direction", "crossing status",
	...
	public void evaluateVehicleFile(List<String> vehicleLine, LinkedList<Phases> phaseList)
			throws InaccurateDataException, DuplicateIDException, NumberFormatException {
		...
		vehicleAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (car == null) {
						throw new InaccurateDataException(
								"The row with " + newVehicleLine.get(0) + "could not be created");
					}
...
//                    	cSField.setText(""); //field is now uneditable so no need to clear it
	...
	public JScrollPane addStatsDisplayPane(LinkedList<Phases> phaseList) {
		String[] columnNames = { "Segment", "No. of Vehicles Waiting", "Waiting Time", "Waiting Length",
				"Avg. Cross Time" };
